        ...
        <form action="manage_cart.php" method="POST">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Price : 150D</p>
                   <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
        ...
        <div class="col-lg-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Price : 110D</p>
                   <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
        ...
        <form action="manage_cart.php" method="POST">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Price : 160D</p>
                   <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
        ...
        <form action="manage_cart.php" method="POST">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Price : 250D</p>
                   <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
       ...
       <form action="manage_cart.php" method="POST">
           <div class="card">
               ...
               <div class="card-body">
                   ...
                   <p class="card-text">Price :  100D</p>
                  <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
       ...
       <div class="col-lg-3">
           ...
           <div class="card">
               ...
               <div class="card-body">
                   ...
                   <p class="card-text">Price : 140D</p>
                  <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
       ...
       <form action="manage_cart.php" method="POST">
           <div class="card">
               ...
               <div class="card-body">
                   ...
                   <p class="card-text">Price :  360D</p>
                  <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
       ...
       <form action="manage_cart.php" method="POST">
           <div class="card">
               ...
               <div class="card-body">
                   ...
                   <p class="card-text">Price :  220D</p>
                  <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
       ...
       <form action="manage_cart.php" method="POST">
           <div class="card">
               ...
               <div class="card-body">
                   ...
                   <p class="card-text">Price :  120D</p>
                  <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
       ...
       <form action="manage_cart.php" method="POST">
           <div class="card">
               ...
               <div class="card-body">
                   ...
                   <p class="card-text">Price :  170D</p>
                  <button type="submit" name="add_to_cart" class="btnn">Add to Cart</button>
